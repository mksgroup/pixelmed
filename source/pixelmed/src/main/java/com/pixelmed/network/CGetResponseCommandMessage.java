...
public class CGetResponseCommandMessage implements CommandMessage {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/CGetResponseCommandMessage.java,v 1.10 2020/01/01 15:48:19 dclunie Exp $";
