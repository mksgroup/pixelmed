...
public class IdentifierHandler {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/IdentifierHandler.java,v 1.13 2020/01/01 15:48:20 dclunie Exp $";
