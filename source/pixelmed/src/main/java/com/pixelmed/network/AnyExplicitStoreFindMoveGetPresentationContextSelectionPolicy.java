...
public class AnyExplicitStoreFindMoveGetPresentationContextSelectionPolicy implements PresentationContextSelectionPolicy {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/AnyExplicitStoreFindMoveGetPresentationContextSelectionPolicy.java,v 1.9 2020/01/01 15:48:18 dclunie Exp $";
