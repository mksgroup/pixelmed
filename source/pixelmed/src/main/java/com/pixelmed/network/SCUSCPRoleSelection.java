...
public class SCUSCPRoleSelection {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/SCUSCPRoleSelection.java,v 1.8 2020/01/01 15:48:20 dclunie Exp $";
