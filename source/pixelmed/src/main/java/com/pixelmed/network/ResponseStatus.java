...
public class ResponseStatus {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/ResponseStatus.java,v 1.7 2020/01/01 15:48:20 dclunie Exp $";
