...
public class CompositeInstanceStoreAbstractSyntaxSelectionPolicy implements AbstractSyntaxSelectionPolicy {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/network/CompositeInstanceStoreAbstractSyntaxSelectionPolicy.java,v 1.8 2020/01/01 15:48:19 dclunie Exp $";
