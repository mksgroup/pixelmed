...
public class AddHierarchicalEvidenceSequencetoStructuredReports {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/apps/AddHierarchicalEvidenceSequencetoStructuredReports.java,v 1.8 2020/01/01 15:48:04 dclunie Exp $";
