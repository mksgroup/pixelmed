...
public class KeepOnlyImagePixelModule {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/apps/KeepOnlyImagePixelModule.java,v 1.9 2020/01/01 15:48:05 dclunie Exp $";
