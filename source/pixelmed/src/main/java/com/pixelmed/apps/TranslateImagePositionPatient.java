...
public class TranslateImagePositionPatient {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/apps/TranslateImagePositionPatient.java,v 1.8 2020/01/01 15:48:05 dclunie Exp $";
